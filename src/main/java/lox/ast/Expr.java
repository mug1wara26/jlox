...
public abstract class Expr {
    ...
    public static class TemplateLiteral extends Expr {
        public TemplateLiteral(Expr expression, int start, int end) {
            this.expression = expression;
            this.start = start;
            this.end = end;
        }
    ...
    public static class StringTemplate extends Expr {
        public StringTemplate(String value, List<TemplateLiteral> templates) {
            this.value = value;
        ...
        public final List<TemplateLiteral> templates;
    }
